        ...
        <div>
            <section className="relative bg-zinc-900">
                <div className="container mx-auto px-4 sm:px-6 py-24 sm:py-32 lg:px-8 text-center max-w-[1440px]">
                    <h1 className="flex flex-col lg:flex-row lg:justify-center lg:items-center gap-2 lg:gap-4">
                    ...
                    <p className="mt-6 text-base sm:text-lg md:text-xl text-zinc-300">
                        Experience the ultimate in performance and reliability with our dedicated server solutions.
                    </p>
                    <p className="mt-3 text-base sm:text-lg md:text-xl text-zinc-300">
