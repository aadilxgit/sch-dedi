...
function Plans() {
    return (
      <div className="bg-zinc-950 text-white">
        <div
          className="p-5 py-24 sm:py-6 container mx-auto flex flex-col max-w-[100rem]"
          id="Plans"
        >
          {" "}
          {}
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg/8 text-zinc-300">
              Choose from our range of dedicated servers powered by latest
              generation processors and enterprise-grade hardware.
            </p>
          </div>
          <div className="hidden 2xl:grid grid-cols-7 gap-2 p-5 mt-4">
            {" "}
            {}
            <span className="opacity-90 ls font-bold text-left ml-15 min-w-[280px]">
              MODEL
            </span>
            ...
            <span className="opacity-90 ls font-bold text-center">
              BANDWIDTH
            </span>
          ...
          <div className="2xl:hidden hidden lg:flex flex-row justify-between items-center gap-4 hover:bg-zinc-700 transition-all duration-300 p-5 border-b border-zinc-700">
            <div
              className="relative overflow-hidden rounded-2xl bg-white/[0.03] backdrop-blur-xl p-6 
              ...
              after:rounded-2xl
              shadow-[0_0_50px_-12px] shadow-[#7964e4]/10"
            >
              <div className="flex flex-col gap-2">
                <div className="flex flex-col items-start min-w-[280px]">
                  <span className="ls font-bold text-center whitespace-nowrap">
                    Intel Xeon E3
                  </span>
                ...
                <div className="flex flex-row gap-8 items-center">
                  <div className="flex items-center justify-center">
                    <span className="ls font-medium text-center">
                      32GB+ DDR4
                    </span>
                  </div>
                  <div className="flex items-center justify-center">
                  ...
                  <div className="flex items-center justify-center">
                    <span className="ls font-medium text-center text-lg">
                      $65/mo
                    </span>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-center pr-2">
                <div className="flex gap-2">
                  <button
                    className="details-button flex items-center gap-2 text-white rounded-none border-zinc-500 border-r-4 border-t-4 bg-zinc-600 px-4 py-2 font-bold hover:bg-zinc-500 hover:text-white hover:translate-x-1 transition-all duration-300 whitespace-nowrap max-w-[140px]"
                    data-plan="xeon-e3"
                  >
                    <span>Details</span>
                  </button>
